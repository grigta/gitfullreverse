      ...
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col items-center gap-12 px-4 py-12 sm:px-6">
        ...
        {prompt ? (
          <div
            ref={resultsRef}
            data-results
            className="flex w-full max-w-2xl scroll-mt-24 flex-col gap-6"
          >
            ...
            {explanation ? (
              <div className="relative w-full">
                ...
                <section className="relative z-10 rounded-xl border-[3px] border-zinc-900 bg-[#e8f5e9] p-6">
                  ...
                  <pre className="max-h-[min(50vh,24rem)] overflow-auto whitespace-pre-wrap rounded-lg border border-green-200 bg-white p-4 text-sm leading-relaxed text-zinc-800">
                    {explanation}
                  </pre>
                </section>
              </div>
